...
\definecolor{PORTADA\_0}{cmyk}{1.00,0.00,0.07,0.28,1.00}
\definecolor{PORTADA\_1}{cmyk}{0.58,0.55,0.00,0.44,1.00}
...
\begin{document}
	...
	\input{cuerpo/portada/caratula}% la version de pdf del logo de la unles muy nueva para latex, compilar version mas vieja
%a) Convierte el archivo unl_escudo.pdf a una versión compatible: Utiliza una herramienta de conversión, como Ghostscript o Adobe Acrobat, para convertir el archivo unl_escudo.pdf a una versión anterior del formato PDF, como la versión 1.5. Asegúrate de guardar el archivo convertido en una ubicación accesible y actualiza la referencia en tu archivo LaTeX para apuntar al nuevo archivo convertido.
    ...
    \include{cuerpo/paginas/capitulo1.tex}
            
    \include{cuerpo/paginas/capitulo2.tex}
           
    \include{cuerpo/paginas/capitulo3.tex}
    
    \include{cuerpo/paginas/capitulo4.tex}
    
    \include{cuerpo/paginas/capitulo5.tex}
    
    \include{cuerpo/paginas/capitulo6.tex}
    
    \include{cuerpo/paginas/capitulo7.tex}
    
    \include{cuerpo/paginas/capitulo8.tex}

    \include{cuerpo/paginas/capitulo9.tex}

    \include{cuerpo/paginas/capitulo10.tex}
    
    \include{cuerpo/paginas/capitulo11.tex}
    
    \include{cuerpo/paginas/capitulo12.tex}
    
    \include{cuerpo/paginas/capitulo13.tex}

    \include{cuerpo/paginas/capitulo14.tex}

    \include{cuerpo/paginas/capitulo15.tex} %problemas con los espacion. muchos espacios en blanco y saltos de linea
    
    \include{cuerpo/paginas/capitulo16.tex}
